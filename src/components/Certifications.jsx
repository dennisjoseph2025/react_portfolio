            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    >
                        ...
                        <div className="p-8 bg-neutral-900/30 border border-neutral-800 rounded-2xl hover:border-neutral-700 transition-colors">
                    ...
                    >
                        ...
                        <div className="p-8 bg-neutral-900/30 border border-neutral-800 rounded-2xl hover:border-neutral-700 transition-colors relative group">
